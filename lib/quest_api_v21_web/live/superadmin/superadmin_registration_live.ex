defmodule QuestApiV21Web.Superadmin.SuperadminRegistrationLive do
  ...
  alias QuestApiV21.Admin.Superadmin
  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-sm">
      <.header class="text-center">
        ...
        <:subtitle>
          Already registered?
          <.link navigate={~p"/superadmin/log_in"} class="font-semibold text-brand hover:underline">
            Sign in
          </.link>
          to your account now.
        </:subtitle>
      ...
      <.simple_form
        ...
        action={~p"/superadmin/log_in?_action=registered"}
        method="post"
      >
  ...
  def handle_event("validate", %{"superadmin" => superadmin_params}, socket) do
    changeset = Admin.change_superadmin_registration(%Superadmin{}, superadmin_params)
    {:noreply, assign_form(socket, Map.put(changeset, :action, :validate))}
  end

  defp assign_form(socket, %Ecto.Changeset{} = changeset) do
    form = to_form(changeset, as: "superadmin")
