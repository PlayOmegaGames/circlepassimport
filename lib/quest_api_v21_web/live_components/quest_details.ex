                        ...
                        <div>
                          <span class="flex h-12 w-12 items-center justify-center">
                            <img
                              ...
                              alt="Badge"
                              class={"w-12 h-12 bg-cover rounded-full border-2 borer-white ring-2 #{if badge.collected, do: "ring-brand grayscale-0", else: "opacity-70 grayscale ring-gray-200"}"}
                            />
                          </span>
                        </div>
