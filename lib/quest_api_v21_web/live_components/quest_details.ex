    ...
    >
      ...
      >
        ...
        <span class="w-6 h-6 hero-chevron-down"></span>
            ...
            <h3
              class="overflow-hidden mr-8 w-full text-2xl font-medium text-center"
              id="modal-title"
            >
              <%= @quest_details.name %>
            </h3>
            <p class="mt-2 text-gold-200 text-center">Quest Size: <%= length(@quest_details.badges) %> badges</p>
