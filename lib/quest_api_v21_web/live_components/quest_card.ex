defmodule QuestApiV21Web.LiveComponents.QuestCard do
  ...
  def render(assigns) do
    ...
    <div class={"#{@class}relative text-left rounded-lg overflow-hidden shadow-lg cursor-pointer location-card"}>
      ...
      <img src={@quest.quest_image || "/images/questdefault.webp"} alt="Location Image" class="w-full h-32 object-cover">

        <div
          class="absolute inset-0 bg-black/80 z-10 flex flex-col justify-between p-4">
          <div class="my-auto">
