    ...
    <div class={"#{@class} overflow-hidden bg-accent h-48 rounded-xl ring-1 ring-white/[0.40] text-white"}>
      <div class="flex-col justify-center py-4 pl-4">
        <div class="flex justify-between">
          ...
          <img class="inline-block relative z-20 w-16 h-16 rounded-full ring-1 object-cover ring-white" src={quest_badge.badge_image} alt={quest_badge.name}>
            <% end %>
          ...
          <div class="overflow-hidden ml-2 w-full">
            ...
            <h4 class="px-8 w-full text-center uppercase truncate bg-highlight"><%= @quest.reward %></h4>
          </div>
        </div>
