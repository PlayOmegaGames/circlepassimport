defmodule QuestApiV21Web.AccountAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_quest_api_v21_web_account_remember_me"
  ...
  Or use the `live_session` of your router to invoke the on_mount callback:
      ...
      live_session :authenticated, on_mount: [{QuestApiV21Web.AccountAuth, :ensure_authenticated}] do
